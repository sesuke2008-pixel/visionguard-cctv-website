...
```bash
git remote add encore encore://visionguard-cctv-website-4gf2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/visionguard-cctv-website-4gf2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/visionguard-cctv-website-4gf2/settings/integrations/github)
